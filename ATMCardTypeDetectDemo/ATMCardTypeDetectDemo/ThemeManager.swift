...
enum Theme: Int {
    ...
    var mainColor: UIColor {
        ...
        case .dark:
            return UIColor().colorFromHexString("0C0250")
        }
    }
    ...
    var creditCardViewColor: UIColor {
        switch self {
        case .light:
            return UIColor().colorFromHexString("ffffff")
        case .dark:
            return UIColor().colorFromHexString("05002D")
        }
    }
    ...
    var buttonTintColor: UIColor {
        switch self {
        case .light:
            return UIColor().colorFromHexString("371CE0")
        case .dark:
            return UIColor.white
        }
    }
